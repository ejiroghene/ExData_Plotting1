...
##set up the plot window/frame by stating how the graphs should be arranged using par function

par(mfrow = c(2,2), mar= c(4,4,2,1), oma= c(0,0,2,1)) ##this implies 2rows2cols, mar=margins, oma=outer margins




##Secondly, plot a graph of Global_active_power used up in relation to the two days stated

plot(PowerDataFeb$DateTime, PowerDataFeb$Global_active_power, type = "l", xlab = "", ylab = "Global Active Power(kilowatts)")##Note that the type of plot required is "l" type ie lines, p=points, s= stair steps etc
...
##Thirdly, plot a graph of Voltage used up in relation to the two days stated

plot(PowerDataFeb$DateTime, PowerDataFeb$Voltage, type = "l", xlab = "Datetime", ylab = "Voltage")##Note that the type of plot required is "l" type ie lines, p=points, s= stair steps etc





##Fourthly, plot a graph that shows the  energy sub metering 1, 2, 3  in different colors 
...
##Fifthly, plot a graph of Global_reactive_power used up in relation to the two days stated

plot(PowerDataFeb$DateTime, PowerDataFeb$Global_reactive_power, type = "l", xlab = "Datetime", ylab = "Global_reactive_power")##Note that the type of plot required is "l" type ie lines, p=points, s= stair steps etc
